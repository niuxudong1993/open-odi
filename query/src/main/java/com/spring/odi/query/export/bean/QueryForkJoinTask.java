...
public class QueryForkJoinTask<T extends Object,Ext extends BaseQueryBean> extends RecursiveTask<ConcurrentHashMap<Integer, List<T>>> {


    private final Integer rowNum = 500;

    private Ext queryBean;
    // 子任务开始计算的值
    ...
    public Ext getQueryBean() {
        return queryBean;
    }

    public void setQueryBean(Ext queryBean) {
